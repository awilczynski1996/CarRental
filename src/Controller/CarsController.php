...
class CarsController extends AbstractController
{
    ...
    {
        return $this->render('cars/index.html.twig', ['cars' => $carsRepository->findAll()]);
    }
    ...
    {
        return $this->render('cars/show.html.twig', ['car' => $car]);
    }
    ...
    public function edit(Request $request, Cars $car): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('cars_edit', ['id' => $car->getId()]);
        }
